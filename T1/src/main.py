...
if __name__ == "__main__":
    ...
    # rectangleRed = shape_detection.rectangleDetection(image, redRes, "red")
    # triangleBlue = shape_detection.triangleDetection(image, blueRes, "blue")
    # triangleRed = shape_detection.triangleDetection(image, redRes, "red")
    # circleBlue = shape_detection.circleDetection(image, blueRes, "blue")
    # circleRed = shape_detection.circleDetection(image, redRes, "red")
